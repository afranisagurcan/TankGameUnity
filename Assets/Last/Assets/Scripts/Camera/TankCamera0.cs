...
/// </summary> 
    ...
    public class TankCamera0 : MonoBehaviour {  
        ...
        void LateUpdate ()
        {
    		...
    		if(mouseSideButton && Input.GetAxis("Vertical1") != 0 )
            ...
            if (GUIUtility.hotControl == 0)
            {
                ...
                else if (Input.GetAxis("Vertical1") != 0 || Input.GetAxis("Horizontal1") != 0 || rotateBehind || mouseSideButton)
                {
                    RotateBehindTarget();
                }
            }
